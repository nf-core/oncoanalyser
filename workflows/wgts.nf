...
workflow WGTS {
    ...
    isofox_read_length = params.isofox_read_length !== null ? params.isofox_read_length : RunModes.DEFAULT_ISOFOX_READ_LENGTH_WTS
    ...
    if (stages.sage_append || stages.orange || stages.neo) {
