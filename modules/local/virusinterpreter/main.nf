process VIRUSINTERPRETER {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/hmftools-virus-interpreter:3.7_beta--hdfd78af' :
        'biocontainers/hmftools-virus-interpreter:3.7_beta--hdfd78af' }"
    ...
    """
    mkdir -p metrics/
    ln -sf \$(realpath ${somatic_metrics}) metrics/
