...
- [Pharmacogenomic analysis](#pharmacogenomic-analysis)
  - [PEACH](#peach) - Pharmacogenomic of haplotypes
...
[PEACH](https://github.com/hartwigmedical/hmftools/tree/master/peach) infers the most simplest haplotypes supporting
variant calls and interprets these within a pharmacogenomic context.
