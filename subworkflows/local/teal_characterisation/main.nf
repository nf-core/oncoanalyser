    ...
    ch_teal_pipeline_inputs_sorted = channels.WorkflowChannels.groupByMeta(
        ...
        .map { meta, tumor_teal_bam, tumor_teal_bai, normal_teal_bam, normal_teal_bai, tumor_metrics_dir, normal_metrics_dir, cobalt_dir, purple_dir ->
            return [
                ...
                normal_teal_bam,
                normal_teal_bai,
                Inputs.preferUserProvidedInput(tumor_metrics_dir, meta, Inputs.KEY.BAMTOOLS_DIR_TUMOR),
                Inputs.preferUserProvidedInput(normal_metrics_dir, meta, Inputs.KEY.BAMTOOLS_DIR_NORMAL),
