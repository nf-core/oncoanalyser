...
workflow READ_ALIGNMENT_DNA {
    ...
    ch_inputs_tumor_sorted = ch_inputs
        .branch { meta ->
            def has_existing = Inputs.hasExistingInput(meta, Constants.INPUT.BAM_DNA_TUMOR)
    ...
    ch_inputs_normal_sorted = ch_inputs
        .branch { meta ->
            def has_existing = Inputs.hasExistingInput(meta, Constants.INPUT.BAM_DNA_NORMAL)
    ...
    ch_inputs_donor_sorted = ch_inputs
        .branch { meta ->
            def has_existing = Inputs.hasExistingInput(meta, Constants.INPUT.BAM_DNA_DONOR)
