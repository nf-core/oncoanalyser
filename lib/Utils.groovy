...
class Utils {
            ...
            .collect { group_id, entries ->
                ...
                entries.each {
                    ...
                    if (it.containsKey('info')) {
                        ...
                        // Only allow READ_GROUP for FASTQ
                        if (filetype_enum != Constants.FileType.FASTQ && info_data.containsKey(Constants.InfoField.READ_GROUP)) {
                    ...
                    if (filetype_enum == Constants.FileType.FASTQ) {
                        ...
                        def rg_fields = [:]
                        if (info_data.containsKey(Constants.InfoField.READ_GROUP)) {
                            rg_fields = Utils.parse_read_group_info(info_data[Constants.InfoField.READ_GROUP], log)
                        }
    ...
    static public parse_read_group_info(rg_info_raw, log) {
        def escape_char = "\u0000"
    ...
    static public getTumorDnaReduxInput(meta) {
        def meta_sample = getTumorDnaSample(meta)
    ...
    static public hasTumorDnaReduxInput(meta) {
    ...
    static public getNormalDnaReduxInput(meta) {
    ...
    static public hasNormalDnaReduxInput(meta) {
    ...
    static public hasDnaReduxInput(meta) {
    ...
    static public getDonorDnaReduxInput(meta) {
    ...
    static public hasDonorDnaReduxInput(meta) {
